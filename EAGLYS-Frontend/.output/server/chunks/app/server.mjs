...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/App-ded05cb0.mjs').then((m) => m.default || m)
  },
  {
    name: "mainPage",
    path: "/mainPage",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/mainPage-1e22de28.mjs').then((m) => m.default || m)
  },
  {
    name: "testPage",
    path: "/testPage",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/testPage-ec3d1a94.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-2141e919.mjs').then((r) => r.default || r));
